...
class DCL_Agent_Repeated_Games():
    def __init__(self, temperature, hidden_dim, lr_critic, lr_actor, with_constraints, gamma, is_entropy, temperature_decay, mega_step, state_dim, action_dim, num_agents,device="cpu"):
        self.device = device
        self.gamma = gamma
